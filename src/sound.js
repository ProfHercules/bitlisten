  ...
  // INSTRUMENT 1
    ...
    if (swells1.length === 0) {
      for (i = 1; i <= 3; i++) {
        newSound = new Howl({
          urls: [
            "sounds/swells1/planetswell" + i + ".ogg",
    ...
    $("#musicianDonation").html(
      musicianString + "<span>" + SOUND_DONATION_ADDRESS + "</span>"
    );
  }
  // INSTRUMENT 2
    ...
    if (sound2.length === 0) {
      for (i = 1; i <= 13; i++) {
        ...
        newSound = new Howl({
          src: [
            "sounds/wikki/" + "wikki" + istring + ".ogg",
    ...
    if (swells2.length === 0) {
      for (i = 1; i <= 3; i++) {
        newSound = new Howl({
          src: [
            "sounds/swells2/wikkiswell" + i + ".ogg",
