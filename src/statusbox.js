...
StatusBox.init = function (debugmode) {
  ...
  if ($("#mtgoxCheckBox").is(":checked")) StatusBox.reconnecting("mtgox");
...
StatusBox.connected = function (type) {
  ...
  if (type == "mtgox")
    StatusBox.mtgox.html(
      'Mt.Gox Trades: <span style="color: green;">' + CONNECTED + "</span>"
    );
};
...
StatusBox.reconnecting = function (type) {
  ...
  if (type == "mtgox")
    StatusBox.mtgox.html(
      'Mt.Gox Trades: <span style="color: yellow;">' + CONNECTING + "</span>"
    );
};
...
StatusBox.nosupport = function (type) {
  ...
  if (type == "mtgox")
    StatusBox.mtgox.html(
      'Mt.Gox Trades: <span style="color: red;">' + NO_SUPPORT + "</span>"
    );
};
...
StatusBox.closed = function (type) {
  ...
  if (type == "mtgox")
    StatusBox.mtgox.html(
      'Mt.Gox Trades: <span style="color: gray;">' + CLOSED + "</span>"
    );
};
